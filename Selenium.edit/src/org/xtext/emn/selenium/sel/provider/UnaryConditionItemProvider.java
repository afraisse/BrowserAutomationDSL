...
/**
 * This is the item provider adapter for a {@link org.xtext.emn.selenium.sel.UnaryCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryConditionItemProvider extends ConditionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnaryCondition_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnaryCondition_op_feature", "_UI_UnaryCondition_type"),
				 SelPackage.Literals.UNARY_CONDITION__OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelPackage.Literals.UNARY_CONDITION__ELEM);
		}
	...
	public String getText(Object object) {
		UnaryOp labelValue = ((UnaryCondition)object).getOp();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelPackage.Literals.UNARY_CONDITION__ELEM,
