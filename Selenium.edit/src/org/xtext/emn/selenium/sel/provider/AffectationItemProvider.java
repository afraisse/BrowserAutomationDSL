...
/**
 * This is the item provider adapter for a {@link org.xtext.emn.selenium.sel.Affectation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AffectationItemProvider extends InstructionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelPackage.Literals.AFFECTATION__VARIABLE);
			childrenFeatures.add(SelPackage.Literals.AFFECTATION__VALUE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Affectation.class)) {
			...
			case SelPackage.AFFECTATION__VALUE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelPackage.Literals.AFFECTATION__VARIABLE,
				 SelFactory.eINSTANCE.createVariable()));

		newChildDescriptors.add
			(createChildParameter
				(SelPackage.Literals.AFFECTATION__VALUE,
