...
/**
 * This is the item provider adapter for a {@link org.xtext.emn.selenium.sel.NotCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NotConditionItemProvider extends ConditionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelPackage.Literals.NOT_CONDITION__CONDITION);
		}
	...
	public String getText(Object object) {
		return getString("_UI_NotCondition_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NotCondition.class)) {
			case SelPackage.NOT_CONDITION__CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelPackage.Literals.NOT_CONDITION__CONDITION,
