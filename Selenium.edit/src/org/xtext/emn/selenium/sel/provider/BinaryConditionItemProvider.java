...
/**
 * This is the item provider adapter for a {@link org.xtext.emn.selenium.sel.BinaryCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryConditionItemProvider extends ConditionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SelPackage.Literals.BINARY_CONDITION__OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SelPackage.Literals.BINARY_CONDITION__ELEM);
			childrenFeatures.add(SelPackage.Literals.BINARY_CONDITION__VALUE);
		}
	...
	public String getText(Object object) {
		BinaryOp labelValue = ((BinaryCondition)object).getOp();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SelPackage.Literals.BINARY_CONDITION__ELEM,
		...
		newChildDescriptors.add
			(createChildParameter
				(SelPackage.Literals.BINARY_CONDITION__VALUE,
				 SelFactory.eINSTANCE.createValue()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SelPackage.Literals.BINARY_CONDITION__ELEM ||
			childFeature == SelPackage.Literals.BINARY_CONDITION__VALUE;
