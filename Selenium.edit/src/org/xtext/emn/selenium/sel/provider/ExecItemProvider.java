...
/**
 * This is the item provider adapter for a {@link org.xtext.emn.selenium.sel.Exec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecItemProvider extends InstructionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exec_sequence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Exec_sequence_feature", "_UI_Exec_type"),
				 SelPackage.Literals.EXEC__SEQUENCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParamsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exec_params_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Exec_params_feature", "_UI_Exec_type"),
				 SelPackage.Literals.EXEC__PARAMS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		return getString("_UI_Exec_type");
	}
